namespace InvoiceManager.Migrations
{
    ...
    public partial class FixFkMethodOfPayment : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        MethodOfPayementId = c.Int(nullable: false),
                        PayementDate = c.DateTime(nullable: false),
                ...
                .ForeignKey("dbo.MethodOfPayments", t => t.MethodOfPayementId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId)
                .Index(t => t.MethodOfPayementId)
                .Index(t => t.ClientId)
                .Index(t => t.UserId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Invoices", "MethodOfPayementId", "dbo.MethodOfPayments");
            ...
            DropIndex("dbo.Invoices", new[] { "MethodOfPayementId" });
